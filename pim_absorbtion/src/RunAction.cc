...
{ 
 ...
 // analysisManager->SetFileName("B4");
  ...
  // Creating histograms
  //analysisManager->CreateH1("Edep","Edep in tube", 60, 0., 600*keV);
  ...
  // Creating ntuple
 //
  analysisManager->CreateNtuple("B4", "particle information");
...
{ 
  ...
  // Open an output file
  //
  G4String fileName = "B4'";               // file opening command moved to the class constructor
